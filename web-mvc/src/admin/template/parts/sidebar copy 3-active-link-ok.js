...
function activeLink() {
    function updateActiveLink() {
        // Build the current URL path using pathname and search
    ...
    // Initial call when the function is first executed
    updateActiveLink();
    ...
    // Listen for the custom 'navigated' event to update the link
    document.addEventListener('navigated', updateActiveLink);
}

//activeLink();
//console.log(window.location.href)
export {adminSidebar, activeLink}